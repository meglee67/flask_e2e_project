    ...
    if medicine and insurance_provider:
        ...
        if coverage:
            coverage_info = {
                ...
                'price': f'${coverage.price}' if coverage.price is not None else 'Price information unavailable'
            }

            response_data = {
                'medicine_name': medicine.name,
                'insurance_provider': insurance_provider.name,
                'coverage': f'{"Covered" if coverage.covered else "Not Covered"} - {coverage_info["price"]}',
            }
