...
def get_medicine_info():
    ...
    print("Medicine:", medicine)  # Check medicine details
    print("Insurance Provider:", insurance_provider)  # Check provider details
    ...
    if medicine and insurance_provider:
        ...
        print("Coverage:", coverage)  # Check coverage details
        ...
        if coverage:
            ...
            cost_covered = 'Cost information unavailable'
            cost_not_covered = 'Cost information unavailable'

            if coverage.covered:
                cost_covered = coverage.price
            else:
                cost_not_covered = coverage.price
            ...
            response_data = {
                ...
                'cost': {
                    ...
                    'cost_not_covered': cost_not_covered
                }
            }
